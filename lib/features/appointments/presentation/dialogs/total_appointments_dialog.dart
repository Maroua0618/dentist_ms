          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // Patient
                Expanded(
                  child: _buildInfoColumn('Patient', app.patientName, Icons.person),
                ),

                // Doctor
                Expanded(
                  child: _buildInfoColumn('Doctor', 'Dr. ${app.doctorName}', Icons.local_hospital),
                ),
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Date & Time', style: TextStyle(fontSize: 13, color: Colors.grey)),
                      const SizedBox(height: 8),
                      Text(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppointmentUtils.getStatusColor(app.status), width: 1.5),
                  ),
                  child: Text(
