...
class DashboardRemoteDataSource {
  ...
  Future<DashboardMetrics> getDashboardMetrics({
    ...
    try {
      ...
      print(
        'Average Revenue Per Patient: ${averageRevenuePerPatient.toStringAsFixed(2)} DA',
      );
      ...
      print(
        'Previous period: ${previousStartDate.toIso8601String()} to ${previousEndDate.toIso8601String()}',
      );
      ...
      if (previousPatientCount > 0) {
        final patientChange =
            ((totalPatients - previousPatientCount) /
      ...
      if (previousAppointmentCount > 0) {
        final appointmentChange =
            ((completedAppointments - previousAppointmentCount) /
